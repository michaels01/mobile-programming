package michael.android.chess.puzzle;
...
import michael.chess.*;
import michael.chess.board.BoardConstants;
import michael.chess.board.BoardMembers;
				...
				_thread = new Thread(new Runnable(){
		        	public void run(){
		        		...
		        		try{
				        	...
				        	byte[] b = new byte[1024*32]; int len;
